# Generated by Powerlevel10k configuration wizard on 2020-05-19 at 18:19 MSK.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # kgoenv                   # go environment (https://github.com/syndbg/goenv)
    # knodenv                  # node.js version from nodenv (https://github.com/nodenv/nodenv)
    # knvm                     # node.js version from nvm (https://github.com/nvm-sh/nvm)
    # knodeenv                 # node.js environment (https://github.com/ekalinin/nodeenv)
    ...
    # knordvpn                 # nordvpn connection status, linux only (https://nordvpn.com/)
